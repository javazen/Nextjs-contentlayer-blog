...
const Header = () => {
  ...
  return (
    <header className="w-full p-4  px-5 sm:px-10 flex items-center justify-between">
      <Logo /> rounded transition-all ease duration-200 
      <button className="inline-block z-50 sm:hidden rounded transition-all ease duration-200" onClick={toggle}>
      ...
      <nav className="w-max py-3 px-6 sm:px-8 border border-solid rounded-full font-medium capitalize 
      ...
      <nav className="w-max py-3 px-8 border border-solid rounded-full font-medium capitalize 
      ...
      <div className="hidden sm:flex items-center">
        ...
        <a href={siteMetadata.github} className="inline-block w-6 h-6 mr-4"><GithubIcon className="hover:scale-125 transition-all ease duration-150 dark:fill-light" /></a>
