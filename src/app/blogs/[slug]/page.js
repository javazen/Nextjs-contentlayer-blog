...
export async function generateMetadata({ params }) {
    ...
    const modifiedAt = new Date(blog.updatedAt || blog.publishedAt).toDateString();
...
export default function BlogPage({ params }) {
    ...
    const jsonLd = {
        ...
        "description": blog.description,
        "image": imageList,
        "datePublished": new Date(blog.publishedAt).toDateString(),
        "dateModified": new Date(blog.updatedAt || blog.publishedAt).toDateString(),
        "author": [{
            "@type": "Person",
            ...
            top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2'>
                ...
                <div className='grid grid-cols-12 gap-y-8 lg:gap-8 sxl:gap-16 mt-8 px-5 md:px-10'>
                    <div className='col-span-12 lg:col-span-4'>
                        <details className='border-[1px] border-solid border-dark dark:border-light text-dark dark:text-light rounded-lg p-4 sticky 
